        ...
        <>
            {type === 'textarea'
                ? (<textarea
                    ...
                    className={`block w-full px-3 py-2 border bg-transparent rounded border-slightly-lighter-dark-blue text-gray-800 focus:border-none focus:outline-none focus:ring-2 focus:ring-white transition ease-in-out duration-300 ${fieldError ? 'border-red-700' : ''}`}
                />)
                : (<input
                    ref={ref}
                    type={type}
